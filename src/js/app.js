...
cookiecook();
connectForms('https://alexsab.ru/lead/baic/krasnodar/', {
...
grecaptcha.ready(function() {
	grecaptcha.execute('6Lepfy4pAAAAAAGHFP655qNe6Bb_BcskklcxajC6', {action: 'baic_krasnodar'}).then(function(token) {
